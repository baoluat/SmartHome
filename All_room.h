...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label_hello->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 30));
			this->label_hello->ForeColor = System::Drawing::Color::Gainsboro;
			this->label_hello->Location = System::Drawing::Point(597, 442);
			this->label_hello->Name = L"label_hello";
			this->label_hello->Size = System::Drawing::Size(139, 58);
			this->label_hello->TabIndex = 7;
			this->label_hello->Text = L"Hello";
			// 
			// label_name
			// 
			this->label_name->AutoSize = true;
			this->label_name->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 30));
			this->label_name->ForeColor = System::Drawing::Color::Gainsboro;
			this->label_name->Location = System::Drawing::Point(742, 442);
			this->label_name->Name = L"label_name";
			this->label_name->Size = System::Drawing::Size(159, 58);
...
#pragma endregion
	private: System::Void All_room_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		commandSelect.CommandText = "SELECT * FROM users WHERE Username = '" + checkUsername + "';";
