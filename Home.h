...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->labelTime->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.5F));
			this->labelTime->ForeColor = System::Drawing::Color::Gainsboro;
			this->labelTime->Location = System::Drawing::Point(1128, 20);
			this->labelTime->Name = L"labelTime";
			this->labelTime->Size = System::Drawing::Size(67, 29);
			...
			this->panel2->Size = System::Drawing::Size(57, 61);
...
#pragma endregion
	...
	private: System::Void Home_Load(System::Object^ sender, System::EventArgs^ e) {
		timer1->Start();
		this->Active(gcnew SmartHome::All_room);
	}
