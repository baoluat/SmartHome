...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label4->Size = System::Drawing::Size(152, 44);
			this->label4->TabIndex = 0;
			this->label4->Text = L"Kitchen";
			// 
			// timer1
			// 
			this->timer1->Tick += gcnew System::EventHandler(this, &Kitchen::timer1_Tick);
			// 
			// Kitchen
			// 
			...
			this->Name = L"Kitchen";
			this->Text = L"Kitchen";
			this->Load += gcnew System::EventHandler(this, &Kitchen::Kitchen_Load);
...
#pragma endregion
	private: System::Void Kitchen_Load(System::Object^ sender, System::EventArgs^ e) {
		timer1->Start();
	}
